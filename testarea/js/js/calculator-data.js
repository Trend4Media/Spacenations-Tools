...
class CalculatorDataManager {
    ...
    async init() {
        try {
            ...
            console.log('📊 CalculatorDataManager initialisiert');
    ...
    async loadUserBattleData() {
        try {
            ...
            console.log('📊 Lade Kampfdaten für User:', this.currentUser.uid);
            ...
            console.log('✅ Kampfdaten geladen:', this.battleHistory.length, 'Kämpfe');
    ...
    async saveBattle(battleData) {
        try {
            ...
            console.log('✅ Kampf gespeichert:', docRef.id);
            return docRef.id;
    ...
    calculateStatistics() {
        ...
        console.log('📈 Statistiken aktualisiert:', this.statistics);
    }
    ...
    async deleteBattle(battleId) {
        try {
            ...
            console.log('✅ Kampf gelöscht:', battleId);
            return true;
